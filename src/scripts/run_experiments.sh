...
for dataset in "l2rpn" "apartment" "solar_home"; do
    for attack in "none" "empty" "lie" "ipm"; do
        for server_aggregator in "fedavg" "median" "topk" "krum" "trimmed_mean" "phocas" "geomedian" "kickback_momentum" "fedprox" "mrcs" "ssfgm"; do
            for ms_aggregator in "fedavg" "median" "topk" "krum" "trimmed_mean" "phocas" "geomedian" "kickback_momentum" "fedprox" "mrcs" "ssfgm"; do
